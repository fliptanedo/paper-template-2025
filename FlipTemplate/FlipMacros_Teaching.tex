...
% Create a custom clone of the 'enumerate' list specifically for problems; via Gemini
\newlist{problems}{enumerate}{1}
\setlist[problems]{
    label=\textbf{Problem \thechapter.\arabic*},
    leftmargin=*,
    before=\small, % Drops the font size to small for the whole list
    itemsep=2em    % Generates healthy breathing room between long problems
}
